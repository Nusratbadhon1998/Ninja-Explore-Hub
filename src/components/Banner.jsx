...
function Banner() {
  return (
    <div className="flex flex-col md:flex-col lg:flex-row gap-5 items-center w-full h-[600px] relative">
      <img className="absolute opacity-70 inset-0 w-full h-full" src={bg} alt="" />
      {/* First Part */}
      <div className="relative z-20 w-full md:w-full lg:w-1/3 space-y-3 ml-8">
        <h1
          className={`text-xl text-stone-200 md:text-3xl lg:text-5xl font-bold`}
        >
          <Typewriter
            cursor
            cursorBlinking
