...
function GetInTouch() {
  return (
    <div className='relative  my-20 '>
        ...
        <div className='max-w-5xl relative z-10 mx-auto flex flex-col justify-center items-center bg-yellow-100 bg-opacity-35 p-3 lg:p-40  rounded-2xl space-y-5'>
            <h1 className='text-3xl font-bold text-stone-800'>Trusted By People Around the world</h1>
